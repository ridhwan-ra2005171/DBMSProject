...
VALUES
    ...
    ('3456', 'James', 'M', 'Rodriguez', '1992-12-02', '789 Oak St', 'Male', '555-345-6789', '2017-08-05', FALSE, '678'),
	('4567', 'Sara', 'L', 'Khan', '1993-07-21', '567 Pine St', 'Female', '555-456-7890', '2018-04-15', FALSE, '678'),
...
-- Inserting data into Secretary table
...
-- Insert sample data into Technician tablesecretary
...
-- Insert sample data into Engineer tabl
...
INSERT INTO Trade_Union (UnionID, UnionName, UnionAddress, TotalMembers)
VALUES
    ('UNION001', 'Engineering Union', '123 Union St', 1000),
    ('UNION002', 'Labor Union', '456 Labor Ave', 800),
    ('UNION003', 'Technical Workers Union', '789 Tech Rd', 1200),
	('UNION004', 'Healthcare Workers Union', '456 Health Rd', 1500),
    ('UNION005', 'Teachers Union', '789 Education Ave', 900),
    ('UNION006', 'Transport Workers Union', '123 Transport Blvd', 1100);
